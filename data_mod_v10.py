...
def GRIND_04_Click():
    ...
    df44 = df44[df9['Z2.GRINDEND'].notna()]
    df12 = df44
...
def Z1_CURRENT_PLOT_Click():
    ...
    df.plot(x='CASETTE#', y='Z1.GRINDEND', kind='line', linestyle='-', marker='.', markersize='4')
...
def Z2_CURRENT_PLOT2_Click():
    ...
    df.plot(x='CASETTE#', y='Z2.GRINDEND', kind='line', linestyle='-', marker='.', markersize='4')
...
def Z1_WEAR_PLOT_Click():
    ...
    df.plot(x ='CASETTE#', y='Z1.CALWEAR', kind='line', linestyle='-', marker='.', markersize='4')
...
def Z2_WEAR_PLOT2_Click():
    ...
    df.plot(x ='CASETTE#', y='Z2.CALWEAR', kind='line', linestyle='-', marker='.', markersize='4')
